---
slug: naming-season-update-1
title: ENS Contract Naming Season update 1
description: Teams across the ecosystem are naming their contracts, in this update we share why it exists, what's changed so far and what to expect next.
authors: [conor]
...
When ENS Contract Naming Season [launched](/blog/contract-naming-season), our goal was simple — to increase trust for users of smart contracts in Ethereum through contract naming with ENS.
...
At the time of publication, we’ve already shared updates about [Cork](/blog/cork), [Liquity](/blog/liquity) and [Nouns DAO](/blog/nouns), with more to follow very soon!
...
- **[Batch contract naming](/blog/batch-naming)**, to support large deployments
- **[Full Safe support](/blog/enscribe-safeapp)**, aligning with standard treasury and admin setups
- **[Calldata export](/blog/viewing-calldata)**, enabling review, coordination, and use with custom multisig workflows

...
## 4,665 ENS have been distributed
...
So far, **4,665 ENS** have been distributed across **31 teams and individuals**.
...
If you have not already, head over to the <AppUrl>Enscribe App</AppUrl> to get started.

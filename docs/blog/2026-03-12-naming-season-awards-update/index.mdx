...
description: "The first batch of ENS Contract Naming Season awards has been distributed, with 4,665 ENS allocated so far and two months left in the program."
authors: [conor]

...
![namespace example](/img/enscribe-namespace-landing.png)
...
- [**Safe**](/docs/enscribe/manager-modes/safe): Deploy a new Safe that holds manager rights. Enscribe is one of the required signers.
- [**Enscribe**](/docs/enscribe/manager-modes/enscribe): Transfer manager access directly to the Enscribe-managed address.
- [**Smart session**](/docs/enscribe/manager-modes/smart-session): Shown in the UI as coming soon.
...
The last step lets you invite members by email. This step is optional. You can skip it and invite people later from **Organization management**.
